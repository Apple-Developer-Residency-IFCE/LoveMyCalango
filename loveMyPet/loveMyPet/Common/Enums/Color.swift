...
//  loveMyPet
//
//  Created by Rodrigo Mendes on 13/06/23.
//
...
enum CustomColor {
    ...
    static let MainColorHeavy = "MainColorHeavy"
    static let MainColorSoft = "MainColorSoft"
    static let HelperAlert = "HelperAlert"
    ...
    static let LaunchScreenBackground = "LauchScreenBG"
